--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('ADMINISTRADOR', 'adm', 'adm@teste.com', '12345678', '1', true, '1');
--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('MODERADOR', 'mod', 'mod@teste.com', '12345678', '1', true, '1');
--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('USUARIO', 'usr', 'usr@teste.com', '12345678', '1', true, '1');
--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('Donilo', 'Don616', 'contato.pontes@bandtec.com.br', '12345678', '5', true, '1');
--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('Hanna', 'H4nn4', 'hanna.santos@bandtec.com.br', '12345678', '4', true, '1');
--insert into tb_user (name, nickname, email, password, avatar, is_active, avatar_png) values ('Letícia', 'Let1ci4', 'leticia.costa@bandtec.com.br', '12345678', '3', true, '1');
