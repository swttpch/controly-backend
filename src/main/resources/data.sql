...
insert into tb_topic (name, about) values ('Flutter', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Java', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('React', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('JS', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Html', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Php', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Spring', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Laravel', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Mysql', 'Um kit de desenvolvimento que blá blá');
insert into tb_topic (name, about) values ('Css', 'Um kit de desenvolvimento que blá blá');
...
insert into tb_doubts_answer (is_solved, solved_in, id_answer, id_post) values (1, '2022-10-22', 8, 3);
